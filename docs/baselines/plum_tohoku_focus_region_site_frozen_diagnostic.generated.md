# PLUM Tohoku Focus Region/Site Frozen Diagnostic
...
| Site | Validation P+/P | Test P+/P | Delta |
| --- | ---: | ---: | ---: |
| `hokkaido` | 0 / 0.0% | 0 / 0.0% | +0.0pp |
| `tohoku` | 368 / 83.4% | 783 / 43.8% | -39.6pp |
| `kanto_chubu` | 89 / 92.1% | 268 / 42.9% | -49.2pp |
| `west_south` | 0 / 0.0% | 0 / 0.0% | +0.0pp |

### Joint Buckets

| Region | Site | Validation P+/P | Validation Band | Test P+/P | Delta |
| --- | --- | ---: | --- | ---: | ---: |
| `tohoku` | `kanto_chubu` | 89 / 92.1% | `high` | 268 / 42.9% | -49.2pp |
| `tohoku` | `tohoku` | 368 / 83.4% | `high` | 783 / 43.8% | -39.6pp |

### Band Transfer

| Band | Validation Buckets | Validation P+/P | Test P+/P | Delta |
| --- | ---: | ---: | ---: | ---: |
| `high` | 2 | 457 / 85.1% | 1051 / 43.6% | -41.5pp |
...
| --- | ---: | ---: | ---: |
| `hokkaido` | 0 / 0.0% | 0 / 0.0% | +0.0pp |
| `tohoku` | 20 / 90.0% | 40 / 25.0% | -65.0pp |
| `kanto_chubu` | 8 / 100.0% | 0 / 0.0% | -100.0pp |
| `west_south` | 0 / 0.0% | 0 / 0.0% | +0.0pp |
...
| Region | Site | Validation P+/P | Validation Band | Test P+/P | Delta |
| --- | --- | ---: | --- | ---: | ---: |
| `tohoku` | `kanto_chubu` | 8 / 100.0% | `insufficient` | 0 / 0.0% | -100.0pp |
| `tohoku` | `tohoku` | 20 / 90.0% | `high` | 40 / 25.0% | -65.0pp |
...
- Diagnostic-only. This report checks whether the existing geographic region/site view transfers inside the `tohoku` hotspot before adding new production-facing calibration logic.
