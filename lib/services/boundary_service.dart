...
class BoundaryService {
  ...
  static final List<CityLabel> _defaultProvinceLabels = [
    CityLabel(
      name: "北京",
      coord: LatLng(39.93, 116.40),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "天津",
      coord: LatLng(39.14, 117.21),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "河北",
      coord: LatLng(38.05, 114.49),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "山西",
      coord: LatLng(37.87, 112.56),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "内蒙古",
      coord: LatLng(40.82, 111.67),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "辽宁",
      coord: LatLng(41.80, 123.38),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "吉林",
      coord: LatLng(43.88, 125.32),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "黑龙江",
      coord: LatLng(45.80, 126.53),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "上海",
      coord: LatLng(31.25, 121.49),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "江苏",
      coord: LatLng(32.06, 118.80),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "浙江",
      coord: LatLng(30.27, 120.15),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "安徽",
      coord: LatLng(31.87, 117.28),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "福建",
      coord: LatLng(26.05, 119.33),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "江西",
      coord: LatLng(28.68, 115.86),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "山东",
      coord: LatLng(36.65, 117.00),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "河南",
      coord: LatLng(34.76, 113.65),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "湖北",
      coord: LatLng(30.58, 114.30),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "湖南",
      coord: LatLng(28.21, 112.94),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "广东",
      coord: LatLng(23.12, 113.31),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "广西",
      coord: LatLng(22.81, 108.30),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "海南",
      coord: LatLng(20.02, 110.33),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "重庆",
      coord: LatLng(29.54, 106.53),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "四川",
      coord: LatLng(30.57, 104.07),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "贵州",
      coord: LatLng(26.63, 106.71),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "云南",
      coord: LatLng(25.04, 102.68),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "西藏",
      coord: LatLng(29.65, 91.12),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "陕西",
      coord: LatLng(34.34, 108.94),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "甘肃",
      coord: LatLng(36.06, 103.82),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "青海",
      coord: LatLng(36.62, 101.78),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "宁夏",
      coord: LatLng(38.47, 106.27),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "新疆",
      coord: LatLng(43.83, 87.63),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "香港",
      coord: LatLng(22.29, 114.19),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "澳门",
      coord: LatLng(22.19, 113.55),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "台湾",
      coord: LatLng(23.97, 120.96),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "東京",
      coord: LatLng(35.68, 139.65),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "北海道",
      coord: LatLng(43.06, 141.35),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "東北",
      coord: LatLng(38.92, 140.78),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "関東",
      coord: LatLng(36.00, 139.70),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "中部",
      coord: LatLng(35.30, 137.10),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "近畿",
      coord: LatLng(34.85, 135.50),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "中国",
      coord: LatLng(35.86, 104.20),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "モンゴル",
      coord: LatLng(46.87, 103.84),
      level: LabelLevel.province,
    ),
    CityLabel(
      name: "韓国",
      coord: LatLng(36.50, 127.90),
      level: LabelLevel.province,
    ),
  ];
  ...
  void parseGeoJson(String jsonStr, BoundaryLayer layer) {
    ...
    final excludeNames = <String>{'Japan', 'Taiwan', '日本', '台湾', 'JPN', 'TWN'};
    ...
    for (var feature in features) {
      ...
      if (props is Map) {
        ...
        final isoA3 =
            props['ISO_A3']?.toString() ?? props['iso_a3']?.toString() ?? '';
        if (excludeNames.contains(name) || excludeNames.contains(isoA3))
          continue;
      }
  ...
  void parseTopoJson(String jsonStr, BoundaryLayer layer) {
    ...
    final decodedArcs = rawArcs.map<List<LatLng>>((arc) {
      ...
      for (var seg in arc) {
        ...
        points.add(LatLng(y * scaleY + transY, x * scaleX + transX));
      }
      return points;
    }).toList();
  ...
  /// 处理TopoJSON几何对象
  void _processGeometry(
    Map geom,
    List<List<LatLng>> decodedArcs,
    BoundaryLayer layer,
  ) {
