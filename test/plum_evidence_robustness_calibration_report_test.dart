...
import '../tools/build_plum_evidence_robustness_calibration_report.dart';

void main() {
  test('PLUM robustness calibration report is non-suppressive diagnostic', () {
    final temp = Directory.systemTemp.createTempSync('plum_calibration_');
...
Map<String, Object?> _dataset() => {
  ...
  'events': [
    {
      'eventId': 'validation_calibration_event',
      'split': 'validation',
      'truth': {
      ...
      'variants': [
        {
          'variantId': 'validation_calibration_event_mask_20pct',
