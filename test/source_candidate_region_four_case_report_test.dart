...
void main() {
  ...
  test(
    'four-case report locks the current candidate-region guard roles',
    () {
      ...
      expect(
        cases['20260622_kushiro_offshore_m30_jma']!['delayedRecoveredPositiveFrameCount'],
        3,
      );
      expect(
      ...
      expect(
        cases['20260622_tomakomai_south_offshore_m35_hinet']!['acceptedPositiveFrameCount'],
        3,
      );
      expect(
