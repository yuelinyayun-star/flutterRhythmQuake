...
import '../tools/build_plum_tohoku_mismatch_one_sided_transfer_diagnostic_report.dart';
...
void main() {
  test(
    ...
    () {
      ...
      expect(markdown, contains('### Regime Aggregates'));
      expect(markdown, contains('### Mismatch Transfer'));
