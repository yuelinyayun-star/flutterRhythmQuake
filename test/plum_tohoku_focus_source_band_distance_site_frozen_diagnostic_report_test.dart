...
import '../tools/build_plum_tohoku_focus_source_band_distance_site_frozen_diagnostic_report.dart';

void main() {
  test(
    'PLUM Tohoku focus source-band distance/site frozen diagnostic is structured and non-production',
    () {
      final report =
      ...
      expect(markdown, contains('### Source-Band Distance/Site Buckets'));
